  ...
  return (
	...
	<div className="page-wraper">
        ...
        <div className="page-content">
           ...
           <div className="section-full site-bg-white twm-abus3-section-wrap wow fadeInDown" data-wow-offset="100" data-wow-delay="0.2">
                    ...
                    <div className="col-xl-6 col-lg-12 col-md-12">
                        <div className=" twm-abus-st2-section">
                            ...
                            <div className="section-head left">
                                <div className="twm-sm-title left">Services</div>
                                <h2 className="twm-large-title site-text-dark">
                                    We Are Offering A Best Services For You
                                </h2>
                            ...
                            <div className="twm-abus-st2-large-title">
                                <h2 className="twm-title">Services</h2>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-6 col-lg-12 col-md-12 twm-abus3-right-pic">
                        <div className="twm-abus3-right-content">
                            <div className="twm-serv-media">
