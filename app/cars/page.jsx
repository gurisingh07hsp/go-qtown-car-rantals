                            ...
                            <div className="pagination-outer d-flex justify-content-center">
                                <div className="pagination-style1">
                                    <ul className="clearfix">
                                        <li className="prev"><a href="cars.html"><span> <i className="fa-solid fa-chevron-left"></i> </span></a></li>
                                        <li><a href="cars.html">1</a></li>
                                        <li className="active"><a href="cars.html">2</a></li>
                                        <li><a href="cars.html">3</a></li>
                                        <li className="next"><a href="cars.html"><span> <i className="fa-solid fa-chevron-right"></i> </span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div className="twm-search-section-wrap">
                <div className="container">
                    <div className="twm-search-section-area">
                       <h3 className="twm-s-section-title">Available for rent</h3>
